...
const fieldsBlogPost = ["name", 'route', "title", "image_alt", "image_captions", "blog_category", "category_description", "blog_intro", "meta_image", "published_on", "published_time", "blogger"]
